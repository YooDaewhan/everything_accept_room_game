...
function App(): React.JSX.Element {
  ...
  async function connect(join: boolean): Promise<void> {
    ...
    try { setRoom(join ? await client.joinById(codeInput.trim().toUpperCase(), { nickname: name }) : await client.create(ROOM_NAME, { nickname: name })); }
